...
class FileRules {
    ...
    async size(field, file, deleteOnFail, args, message){
        let success =  true;
    ...
    async extension(field, file, deleteOnFail, args, message){
        let success = true;
    ...
    async mime(field, file, deleteOnFail, args, message){
        let success = true;
    ...
    async image(field, file, deleteOnFail, message) {
        let success = true;
    ...
    async name(field, file, deleteOnFail, filename, message){
        let success = true;
